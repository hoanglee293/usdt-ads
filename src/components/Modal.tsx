    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Header */}
                {(title || description) && (
                    <div className="px-4 md:px-6 pt-4 border-b border-gray-200 dark:border-theme-gray-100">
                        {title && (
                            <h2 className="text-xl md:text-2xl font-bold text-theme-red-200 dark:text-theme-red-300 pr-8">
                                {title}
                            </h2>
                        )}
                        {description && (
