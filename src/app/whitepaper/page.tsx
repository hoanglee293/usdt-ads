      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-12">
            ...
            <h3 className="text-2xl font-semibold text-theme-black-100 dark:text-white mt-8 mb-4">
              {t('whitepaper.section1.marketProblems.title')}
            </h3>
            <ul className="list-disc list-inside space-y-3 text-theme-black-100 dark:text-gray-300 mb-6 ml-4">
            ...
            <ul className="space-y-3 text-theme-black-100 dark:text-gray-300 mb-6">
          ...
          <section className="mb-12">
            ...
            <h3 className="text-2xl font-semibold text-theme-black-100 dark:text-white mt-6 mb-4">
              {t('whitepaper.section2.cycle.title')}
            </h3>
            <div className="bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 p-6 sm:p-8 rounded-xl mb-6 border-2 border-gray-200 dark:border-gray-700 shadow-xl">
              <div className="relative">
                {/* Top Flow: User Journey (Left to Right) */}
                <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 mb-6 text-xs sm:text-sm md:text-base">
                ...
                <div className="flex justify-between items-center mb-6 px-4 sm:px-[10vw]">
                  {/* Left Arrow Up */}
            ...
            <div className="space-y-6">
              <div className="bg-white dark:bg-gray-800 border-l-4 border-[#FE645F] pl-6 py-4 rounded-r-lg">
                <h4 className="text-xl font-semibold text-theme-black-100 dark:text-white mb-3">
                  {t('whitepaper.section2.process.step1.title')}
                </h4>
                <ul className="list-disc list-inside space-y-2 text-theme-black-100 dark:text-gray-300 ml-4">
              ...
              <div className="bg-white dark:bg-gray-800 border-l-4 border-[#C68AFE] pl-6 py-4 rounded-r-lg">
                <h4 className="text-xl font-semibold text-theme-black-100 dark:text-white mb-3">
                  {t('whitepaper.section2.process.step2.title')}
                </h4>
                <ul className="list-disc outside list-inside space-y-2 text-theme-black-100 dark:text-gray-300 ml-4">
                  ...
                  <ul className="list-disc outside list-inside ml-8 mt-2 space-y-1">
          ...
          <section className="mb-12">
              ...
              <table className="w-full border-collapse border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 rounded-lg overflow-hidden">
                <thead>
                  <tr className="bg-gradient-to-r from-[#FE645F] to-[#C68AFE] text-white">
                    <th className="border border-gray-300 dark:border-gray-600 px-4 py-3 text-left font-semibold">{t('whitepaper.section3.packages.table.package')}</th>
                    <th className="border border-gray-300 dark:border-gray-600 px-4 py-3 text-left font-semibold">{t('whitepaper.section3.packages.table.capital')}</th>
                    <th className="border border-gray-300 dark:border-gray-600 px-4 py-3 text-left font-semibold">{t('whitepaper.section3.packages.table.videosPerDay')}</th>
                    <th className="border border-gray-300 dark:border-gray-600 px-4 py-3 text-left font-semibold">{t('whitepaper.section3.packages.table.devices')}</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="bg-theme-pink-100">
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3 font-semibold">{t('whitepaper.section3.packages.packageFree')}</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">$10</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">5</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">20</td>
                  </tr>
                  <tr className="bg-theme-pink-100">
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3 font-semibold">{t('whitepaper.section3.packages.packageBasic')}</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">$10-$250</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">100</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">20</td>
                  </tr>
                  <tr className="bg-theme-pink-100">
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3 font-semibold">{t('whitepaper.section3.packages.packageMid1')}</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">$251-$750</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">400</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">40</td>
                  </tr>
                  <tr className="bg-theme-pink-100">
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3 font-semibold">{t('whitepaper.section3.packages.packageMid2')}</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">$751 - $1,250</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">900</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">60</td>
                  </tr>
                  <tr className="bg-theme-pink-100">
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3 font-semibold">{t('whitepaper.section3.packages.packageMid3')}</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">$1,251 - $2,000</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">2,000</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">100</td>
                  </tr>
                  <tr className="bg-theme-pink-100">
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3 font-semibold">{t('whitepaper.section3.packages.packagePremium')}</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">$2,001 - $3,500</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">10,000</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">500</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-500 pl-6 py-4 rounded-r-lg mb-6">
              <p className="text-theme-black-100 dark:text-gray-300 mb-3">
                {t('whitepaper.section3.penalty.description')}
              </p>
              <p className="text-theme-black-100 dark:text-gray-300">
          ...
          <section className="mb-12">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 pl-6 py-4 rounded-r-lg mb-6">
              <p className="text-theme-black-100 dark:text-gray-300 mb-3">
            ...
            <div className="overflow-x-auto mb-6">
              <table className="w-full border-collapse border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800">
                <thead>
                  <tr className="bg-gradient-to-r from-[#FE645F] to-[#C68AFE] text-white">
                    <th className="border border-gray-300 dark:border-gray-600 px-4 py-3 text-left font-semibold">{t('whitepaper.section5.milestones.table.people')}</th>
                    <th className="border border-gray-300 dark:border-gray-600 px-4 py-3 text-left font-semibold">{t('whitepaper.section5.milestones.table.regularReward')}</th>
                    <th className="border border-gray-300 dark:border-gray-600 px-4 py-3 text-left font-semibold">{t('whitepaper.section5.milestones.table.vipReward')}</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="bg-theme-pink-100">
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">5</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">$10</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">$25</td>
                  </tr>
                  <tr className="bg-theme-pink-100">
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">10</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">$15</td>
                  ...
                  <tr className="bg-theme-pink-100">
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">35</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">$50</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">$100</td>
                  </tr>
                  <tr className="bg-theme-pink-100">
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">50</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">$75</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">$150</td>
                  </tr>
                  <tr className="bg-theme-pink-100">
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">75</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">$100</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">$200</td>
                  </tr>
                  <tr className="bg-theme-pink-100">
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">100</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">$150</td>
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-3">$300</td>
                  </tr>
                </tbody>
              </table>
            </div>
            <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg mb-6">
              <p className="text-sm text-theme-black-100 dark:text-gray-300 italic">
          ...
          <section className="mb-12">
            ...
            <div className="bg-green-50 dark:bg-green-900/20 border-l-4 border-green-500 pl-6 py-4 rounded-r-lg mb-6">
              <p className="text-theme-black-100 dark:text-gray-300 mb-3">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6">
              <div className="bg-white dark:bg-gray-800 border-l-4 border-[#FE645F] pl-6 py-4 rounded-r-lg">
                <h3 className="text-xl font-semibold text-theme-black-100 dark:text-white mb-3">
          ...
          <section className="mb-12">
            ...
            <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 pl-6 py-4 rounded-r-lg mb-6">
              <p className="text-theme-black-100 dark:text-gray-300">
          ...
          <section className="mb-12">
            ...
            <p className="text-base sm:text-lg leading-relaxed text-theme-black-100 dark:text-gray-300 mb-6 indent-8 font-semibold">
              {t('whitepaper.section11.paragraph2')}
            </p>
          </section>

          {/* Footer Note */}
          <div className="border-t border-gray-300 dark:border-gray-600 pt-6 mt-12">
