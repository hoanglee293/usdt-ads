        ...
        return (
            <div className='w-full min-h-svh flex py-24 md:pt-28 justify-center items-start px-3 sm:px-4 md:px-6 md:py-6 bg-[#FFFCF9] dark:bg-black flex-1'>
                <div className='w-full max-w-7xl space-y-6'>
                    ...
                    {isNotRegister && (
                        <div className=" max-w-[290px] mx-auto flex justify-center">
                            <Button
                    ...
                    {isSuccess && (
                        <div className='bg-transparent rounded-lg border border-gray-200 dark:border-[#FE645F] p-4 sm:px-6 pt-0 md:max-w-xl mx-auto'>
                            {isLoadingInfo ? (
                                <div className='w-full mx-auto bg-gradient-to-br from-[#FE645F] to-[#C68AFE] rounded-full h-8 sm:h-10 animate-pulse' />
                            ) : (
